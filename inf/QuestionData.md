...
1. General Knowledege: 6 + 8 + 15 + 10 + 2 + 0 = 41 questions
2. Game Mechanics: 0 + 7 + 6 + 2 + 0 + 1...... = 16 questions
3. Crafting Recipes: 5 + 13 + 8 + 3 + 2 + 1.... = 32 questions
4. Updates History: 10 + 19 + 26 + 25 + 14 + 6 = 100 questions
5. Electrics: 14 + 23 + 29 + 89 + 32 + 0...... = 187 questions
...
How many items are given when crafting a single stick?

- 1, 2, 4, 6 (C)
  How many items are given when crafting a single torch?
- 1, 2, 4, 6 (B)
  How many items are given when crafting a single wooden ladder?
- 2, 4, 6, 8 (B)
  How many items are given when crafting a single wooden trapdoor?
- 2, 4, 6, 8 (A)
...
How many items are given when crafting a single wicker lamp?

- 1, 2, 3, 4 (A)
  How many items are given when crafting a single grass trap?
- 4, 6, 8, 12 (B)
  How many items are given when crafting a single spiked plank?
- 2, 4, 6, 8 (A)
  How many items are given when crafting a single wooden fence?
- 2, 4, 6, 8 (A)
  How many items are given when crafting a single wooden fence gate?
- 2, 4, 6, 8 (A)
  How many items are given when crafting a single iron fence?
- 2, 4, 6, 8 (A)
  How many items are given when crafting a single iron fence gate?
- 2, 4, 6, 8 (A)
  How many items are given when crafting a single stone fence?
- 2, 4, 6, 8 (B)
  How many items are given when crafting a single brick fence?
- 2, 4, 6, 8 (B)
  How many items are given when crafting a single basalt fence?
- 2, 4, 6, 8 (B)
  How many items are given when crafting a single wooden sign?
- 2, 4, 6, 8 (A)
  How many items are given when crafting a single iron sign?
- 2, 4, 6, 8 (B)
...
How many items are given when crafting a single piece of string?

- 1, 3, 4, Both A and C (D)
  How many items are given when crafting a single piece of canvas?
- 2, 3, 6, 8 (B)
  How many items are given when crafting a single piece of gunpowder?
- 4, 6, 8, 12 (B)
  How many items are given when crafting a single match?
- 2, 4, 6, 8 (B)
  How many items are given when smelting iron to make a single rod?
- 1, 2, 4, 8 (C)
  How many items are given when smelting logs to make a single piece of coal?
- 1, 2, 4, 6 (A)
  How do you make a multi-state furniture block?
- X.
- X.
- Combine multiple furniture designs in a workbench.
- X. (C)
